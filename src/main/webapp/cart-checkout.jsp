...
<div class="w-8 h-8 rounded-full border border-primary/30 text-primary/50 flex items-center justify-center text-sm font-bold">2</div>
...
<div class="bg-center bg-no-repeat aspect-square bg-cover rounded-lg size-20 shrink-0" data-alt="Garrafa de vinho tinto Brunello di Montalcino" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDNu_bIUkh5fsKRp1io8lQYfh01I02Zs6U7HZ3nZQQuHyJU0ROazjGrq-9f9oxsREhB-VSxfN_LUgkD995CV8JuRHHpRsmiJF8k9wDq6kX2sIiehso5RuBt-fEZ9V0S87-cEQhD7cD2fyJMx3nw5qc2rdsRHk1BbcJy3cxbf-KDKHYX7e5mCgXai7_A4I4tmiX1Toog2ZCZCBm1ze47n26ThMmtQkVK8IuQcjSNZt1-VgCDKwOm2ClKwvfIqKgMXTUruV3nVcRqsIjM");'></div>
<div class="flex flex-col flex-1 min-w-0">
<p class="text-slate-900 dark:text-slate-100 font-display font-medium text-base leading-tight line-clamp-1">Brunello di Montalcino 2017</p>
<p class="text-primary/70 text-sm font-normal mb-2">Toscana, Itália</p>
<div class="flex items-center justify-between">
<p class="text-primary font-bold">R$ 450,00</p>
<div class="flex items-center gap-3 bg-primary/5 rounded-full px-2 py-1">
<button class="text-primary hover:bg-primary/10 rounded-full w-6 h-6 flex items-center justify-center">-</button>
...
<!-- Item 2 -->
<div class="flex items-center gap-4 bg-white dark:bg-primary/5 p-3 rounded-xl border border-primary/5 shadow-sm">
<div class="bg-center bg-no-repeat aspect-square bg-cover rounded-lg size-20 shrink-0" data-alt="Garrafa de vinho branco Chardonnay Reserva" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDk_Dy0yDrvl7FpOiDojIeERUGD4NYY0Oy4EyEtfwdVO688m-PLFI5Xqog-fz8lnR3wL-9C0-T8mOU3w6xREnP81AyyvVNR6_aQ4Nh7537yqIfNHCclsM2aFdB0t1WsVsSkm6nDJGoCh0s-68lnrTt7tqRv7Kh7o_Z-7oigynnABBy87Bvk8n3R7wbYD5KqRyaDwwxl4EpW7iZYOgiSJZ283iAwFf14nm_dhrVkZIzIRvQy4uDILz7L4KfugL5GPbi-PtNtP6UNmaLz");'></div>
<div class="flex flex-col flex-1 min-w-0">
<p class="text-slate-900 dark:text-slate-100 font-display font-medium text-base leading-tight line-clamp-1">Chardonnay Reserva 2020</p>
<p class="text-primary/70 text-sm font-normal mb-2">Mendoza, Argentina</p>
<div class="flex items-center justify-between">
<p class="text-primary font-bold">R$ 180,00</p>
<div class="flex items-center gap-3 bg-primary/5 rounded-full px-2 py-1">
<button class="text-primary hover:bg-primary/10 rounded-full w-6 h-6 flex items-center justify-center">-</button>
...
<input checked="" class="h-5 w-5 rounded border-primary/30 text-primary focus:ring-primary cursor-pointer" id="is_gift" type="checkbox"/>
</div>
<div class="flex-1">
<label class="text-base font-display font-bold text-primary cursor-pointer" for="is_gift">É um presente?</label>
<p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Adicione embalagem especial e uma mensagem escrita à mão por nossa equipe.</p>
<div class="mt-6 space-y-4">
<div>
<label class="block text-xs font-bold text-primary uppercase tracking-widest mb-2">Mensagem do Cartão</label>
<textarea class="w-full bg-background-light dark:bg-background-dark border-primary/10 rounded-lg p-3 text-sm focus:ring-primary focus:border-primary placeholder:italic" placeholder="Escreva sua mensagem aqui..." rows="3"></textarea>
</div>
<div class="flex items-center gap-4 p-3 bg-primary/5 rounded-lg border border-primary/10">
<div class="bg-center bg-no-repeat aspect-square bg-cover rounded size-12" data-alt="Embalagem de presente luxuosa bordô" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDBNe8NF2u_QdG7hwhw2RdE08GAjFjmC0D2dBYkCHWfLQuuZiQ2sHJseF_UORLbJe6ZCM4t_Yw74DSyPAtE-k2IxpcXDkAIwX7lmcPUuj5Zp-xqt9sDgKO4I2Vuda20_hpv_Mh0LmD6FUWwB2aCndfFd7zGhvDzv3nJKp5qnn0cpbVTK1YSKMPcxlSN6kQdfydihvM1ZtE5o6wVf5J5QRkoI41Klgn5DOVLdgwIxDJ15JSqVkJuQsCIhU3uII1YCwP6i3zH3a1nswhh");'></div>
<div class="text-sm">
...
<span class="text-2xl font-display font-bold text-primary">R$ 835,00</span>
<span class="text-xs text-slate-400 line-through">R$ 860,00</span>
</div>
</div>
