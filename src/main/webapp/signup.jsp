		...
		<section class="grid lg:grid-cols-2 gap-6 md:gap-10 items-stretch">
			...
			<article class="bg-white/95 border border-primary/10 rounded-2xl shadow-xl p-6 md:p-8 lg:p-10 fade-up fade-up-delay">
				...
				<% } %>
					...
					<form class="space-y-5" action="${pageContext.request.contextPath}/controller?action=SignUp" method="post">
					...
					<div class="space-y-3 text-sm">
						...
						<label class="inline-flex items-start gap-2.5 cursor-pointer">
							...
							<span class="text-slate-600">Quero receber novidades, ofertas e sugestoes da Vinheria Agnello por e-mail.</span>
						</label>
					</div>
		...
		<section class="mt-10 rounded-xl border border-accent-gold/30 bg-gradient-to-r from-accent-gold/10 to-white p-5 md:p-6 fade-up fade-up-delay-2">
			<div class="flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
				<div>
					...
					<p class="text-sm text-slate-600">Explore o catalogo e veja rotulos pensados para diferentes ocasioes.</p>
				</div>
					<a href="${pageContext.request.contextPath}/controller?action=ShowCatalog" class="inline-flex items-center justify-center gap-2 bg-primary text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-primary/90 transition-colors">
					Ir para o catalogo
					<span class="material-symbols-outlined text-base">arrow_forward</span>
				</a>
			</div>
