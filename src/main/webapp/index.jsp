...
<a href="index.html" class="flex items-center gap-3 px-3 py-3 rounded-lg text-primary bg-primary/5 font-semibold">
...
<a href="signup.html" class="flex items-center gap-3 px-3 py-3 rounded-lg text-slate-700 hover:bg-primary/5 transition-colors">
...
<a class="flex flex-col items-center gap-1 text-slate-400" href="catalog.jsp">
