...
<!-- Product Card 1 -->
<div class="min-w-[200px] bg-white dark:bg-slate-800 rounded-lg overflow-hidden border border-primary/5 shadow-sm">
...
<img alt="Wine bottle" class="h-full object-contain" data-alt="Elegant red wine bottle standing tall" src="https://lh3.googleusercontent.com/aida-public/AB6AXuArRkAQg_J7k3q8Bi2a1i1G_nBMqfmcrggMPZ9rvkl_rOdjsbflZE_LNM1JPYurUhWEBSEgClpwjRYR2vEvaHKyYUDZk1k7it1OEmTVr2Ue33Epw2EW2cIUVVQFbMGXJJZxaeo3k-J-vIiMM4L89WG1EodAjKHP7rP4S3Hcg4KIy_8Dj0MyKWIUmDeoMt91bkRDdc_loeGoMLcpLvMtXwEQQcvrVQQVIWK9I6vOygyCMEZACSj7tn2wP6DDH9TlERsPbc1utfjr6L12"/>
</div>
<div class="p-4">
<p class="text-[10px] text-slate-400 uppercase font-bold">Toscana, Itália</p>
<h4 class="font-display font-bold text-slate-800 dark:text-slate-100 truncate">Brunello di Montalcino</h4>
...
<span class="text-primary font-bold">R$ 489,00</span>
</div>
</div>
</div>
<!-- Product Card 2 -->
<div class="min-w-[200px] bg-white dark:bg-slate-800 rounded-lg overflow-hidden border border-primary/5 shadow-sm">
<div class="h-64 bg-background-light dark:bg-slate-900 flex items-center justify-center p-4 relative">
<img alt="Wine bottle" class="h-full object-contain" data-alt="Classic white wine bottle" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCiqFHcLaUaRpD4R1n-k_x226rjawtOwuhVQ7UR9jL3Jk-9t533Eg8RKkUYwOBcFk_WnSF9YNkrWZv_geaDIVIZG4Nh3rT-v14MAvwmsWz-SBDS08YPhT9glooTpGm8ZSImDyewhc1OnZjyxKfMtlkU4SZPZd08ZAVSrrVy1wsH1kqcY6b2WUlIHIW9BwwABBKAmH_p8wUydnelR6zuHcIQ7zPfiqLLxuxVzOCmpFk7QVACiyg62Xb0JbrTugKIgOKL9CUbStkmqIQd"/>
</div>
<div class="p-4">
<p class="text-[10px] text-slate-400 uppercase font-bold">Bordeaux, França</p>
<h4 class="font-display font-bold text-slate-800 dark:text-slate-100 truncate">Château Margaux 2018</h4>
<div class="flex items-center gap-1 my-2">
<span class="material-symbols-outlined text-accent-gold text-xs fill-1">star</span>
<span class="material-symbols-outlined text-accent-gold text-xs fill-1">star</span>
<span class="material-symbols-outlined text-accent-gold text-xs fill-1">star</span>
<span class="material-symbols-outlined text-accent-gold text-xs fill-1">star</span>
<span class="material-symbols-outlined text-accent-gold text-xs">star</span>
</div>
<div class="flex items-baseline gap-2">
<span class="text-primary font-bold">R$ 1.250,00</span>
</div>
</div>
</div>
</div>
...
<p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-xs mx-auto">
                Desde 1994, a família Agnello percorre as vinícolas mais remotas do mundo para trazer à sua mesa garrafas que contam histórias. Cada vinho em nossa adega é provado e aprovado por nossa curadoria técnica.
            </p>
...
<a href="/controller?action=ShowIndex" class="flex items-center gap-3 px-3 py-3 rounded-lg text-primary bg-primary/5 font-semibold">
<span class="material-symbols-outlined">home</span>Início
</a>
<a href="/controller?action=ShowCatalog" class="flex items-center gap-3 px-3 py-3 rounded-lg text-slate-700 hover:bg-primary/5 transition-colors">
<span class="material-symbols-outlined">liquor</span>Todos os Vinhos
</a>
<a href="/controller?action=ShowSommelier" class="flex items-center gap-3 px-3 py-3 rounded-lg text-slate-700 hover:bg-primary/5 transition-colors">
...
<a class="flex flex-col items-center gap-1 text-slate-400" href="/controller?action=ShowCatalog">
