...
public class RemoveFavorite implements Action {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        System.out.println("Removing product " + productId + " from favorites...");

        ApiResponse apiResponse = new ApiResponse("success", "Item removed from your favorites!");
