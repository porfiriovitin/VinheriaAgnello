...
import br.com.fiap.action.checkout.ShowCheckoutAddress;
import br.com.fiap.action.checkout.ShowCheckoutFinalize;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        actionRegistry.put("ShowCheckoutAddress", new ShowCheckoutAddress());
        actionRegistry.put("ShowCheckoutFinalize", new ShowCheckoutFinalize());
